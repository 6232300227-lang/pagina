// ===== VARIABLES GLOBALES =====
        ...
        // Datos de productos de chaquetas para niño
        const productsData = [
            {
                id: 201,
                ...
                originalPrice: 47.99,
                discount: 25,
                image: "https://shop.mango.com/assets/rcs/pics/static/T2/fotos/S/27054404_TM_B.jpg?ts=1768831543831",
                rating: 3.5,
                reviews: 244,
                badge: "Más vendido"
            },
            {
                ...
                originalPrice: 37.99,
                discount: 34,
                image: "https://assets.theplace.com/image/upload/t_pdp_img_m,f_auto,q_auto/v1/ecom/assets/products/tcp/3014016/3014016_397.jpg",
                rating: 3.5,
                reviews: 244,
                badge: "Más vendido"
            },
            {
                ...
                originalPrice: 40.99,
                discount: 20,
                image: "https://m.media-amazon.com/images/I/312hzCoR6xL._AC_SY1000_.jpg",
                rating: 3.5,
                reviews: 244,
                badge: "Más vendido"
            },
            {
                ...
                originalPrice: 37.99,
                discount: 39,
                image: "https://m.media-amazon.com/images/I/41zbBn5JtPL._AC_SY1000_.jpg",
                rating: 3.5,
                reviews: 244,
                badge: "Más vendido"
            },
            {
                ...
                originalPrice: 53.99,
                discount: 43,
                image: "https://m.media-amazon.com/images/I/4182QolVl9L._AC_.jpg",
                rating: 3.5,
                reviews: 344,
                badge: "Más vendido"
            },
            {
                ...
                originalPrice: 43.99,
                discount: 18,
                image: "https://m.media-amazon.com/images/I/41elveWTHeL._AC_SY1000_.jpg",
                rating: 3.5,
                reviews: 314,
                badge: "Más vendido"
            },
            {
                ...
                originalPrice: 43.99,
                discount: 18,
                image: "https://www.petitelune.com.mx/cdn/shop/files/chaqueta-acolchada-ultraligera-nino-clorofila-XL-4.jpg?v=1709480370&width=1445",
                rating: 3.5,
                reviews: 314,
                badge: "Más vendido"
            },
            {
                ...
                originalPrice: 43.99,
                discount: 18,
                image: "https://m.media-amazon.com/images/I/41SXS7YgfYL._AC_SY350_.jpg",
                rating: 3.5,
                reviews: 314,
                badge: "Más vendido"
            }
            ...
            if (currentPriceFilter !== 'all') {
                filteredProducts = filteredProducts.filter(p => {
                    ...
                    switch(currentPriceFilter) {
                        ...
                        case '25-35': return price > 25 && price <= 35;
